...
PIPELINE_VIS_FIELD_HEIGHT = 360
PIPELINE_VIS_FPS = 25.0
PIPELINE_VIS_DRAW_DETECTIONS = True
PIPELINE_VIS_COVARIANCE_SIGMA = 2.0

# Interactive calibration defaults
CALIBRATION_CAMERAS = ISSIA_CAMERAS
